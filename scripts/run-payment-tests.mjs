...
function loadModule(filePath) {
  ...
  vm.runInNewContext(output, { exports: module.exports, module, require: localRequire, console, JSON, Math, Number, String, Set, Map, Error }, { filename: filePath });
  return module.exports;
}
const testModule = loadModule(path.join(root, 'src/domain/billing/payments.test.ts'));
const result = testModule.runPaymentTests();
console.log('Payment tests passed: ' + result.total + '/' + result.total);
