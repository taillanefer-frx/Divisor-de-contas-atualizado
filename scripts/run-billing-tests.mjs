...
const testModule = loadModule(path.join(root, 'src/domain/billing/billing.test.ts'));
const result = testModule.runBillingTests();
console.log('Billing tests passed: ' + result.total + '/' + result.total);
